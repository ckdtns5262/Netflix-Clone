...
const InfoModal :React.FC<InfoModalProps> = ({visible, onClose}) => {
  ...
  return (
    <div className='transition z-50 duration-300 bg-balck bg-opacity-80 flex items-center justify-center
    overflow-x-hidden overflow-y-auto fixed inset-0'>
        ...
        className='
          ...
          overflow-hidden
        '>
            <div className={`${isVisible} ? 'scale-100' : 'scale-0' transform
            duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
                <div className='relative h-96'>
                    <video className='w-full brightness-[60%} object-cover'
                    autoPlay muted loop 
                    poster={data?.thumbnailUrl} src={data?.videoUrl}>
                    </video>
                    <div className='cursor-pointer absolute top-3 right-3 h-10 w-10 rounded-full
